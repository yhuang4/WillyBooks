$(document).ready(function () {
    ...
    let start = url.indexOf("isbn=") + 5
    let isbn = url.substring(start)
    $("#search-result").text(isbn)
    ...
    db.collection("books").where("isbn", "==", isbn)
        ...
        .then(function (querySnapshot) {
            ...
            if (querySnapshot.docs.length === 0) {
                ...
                $('#no-result').text("Sorry, there are no results for " + isbn)
            }
